...
<ol class="reversed">
  <li><i>Network Evolution: Evolution of Protein Networks and Genomic Conservation</i>, Departmental Seminar Series, <a href="{{ '/assets/pdfs/MISC/departmental.seminar.pdf' | relative_url }}" target="_blank" rel="noopener noreferrer">University of Alabama, Biological Sciences (2025)</a></li>
